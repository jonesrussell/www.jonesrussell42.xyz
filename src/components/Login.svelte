	...
	<div class="flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0">
		...
		>
				...
				<div class="flex flex-col flex-1 justify-center mb-8">
					...
					<div class="w-full mt-4">
						...
						<div class="text-center mt-4">
							<a class="no-underline hover:underline text-blue-dark text-xs" href="/password">
			...
			<div
				...
				style="background: url('https://images.unsplash.com/photo-1515965885361-f1e0095517ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=3300&q=80'); background-position: center center; background-size: cover;"
			/>
		</div>
	</div>
</div>
