<div class="relative flex flex-col items-center justify-center  bg-white bg-cover min-w-screen">
	...
	>
		...
		>
			...
			>
				Designed with<br class="md:hidden lg:block" />
				<span class="text-gray-800">you in mind</span>
			</h1>
			<p
				class="relative z-20 block mt-6 text-base text-gray-500 xl:text-xl sm:text-center lg:text-left"
			>
				We've crafted the ultimate design tool that will help you build the design of your dreams.
				Built with configuration in mind, you can fully customize every aspect.
			</p>
			<div class="relative flex mt-4">
				<a
					href="https://dev.to"
					class="flex items-center self-start justify-center px-5 py-3 mt-5 text-base font-medium leading-tight text-white transition duration-150 ease-in-out bg-purple-500 border border-transparent rounded-full shadow hover:bg-purple-600 focus:outline-none focus:border-purple-600 focus:ring-purple md:py-4 md:text-lg xl:text-xl md:px-10"
					>Get Started</a
				>
				<a
					href="https://dev.to"
