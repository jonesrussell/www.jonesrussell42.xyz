<div class="min-w-screen  bg-gray-100">
  ...
  >
    ...
    >
      <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
        <a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900"
          >Home</a
        >
        <a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900"
          >About</a
        >
        <a href="https://dev.to" class="font-medium hover:text-gray-900"
          >Contact</a
        >
      </nav>
      <a
  ...
  <!-- Header Menu Center -->
  <header
    class="text-gray-700 body-font bg-white shadow-sm w-full mt-5 border-t border-gray-100"
  >
    <div
      class="container mx-auto flex p-6 flex-col md:flex-row items-start justify-between"
    >
      <a
        href="https://dev.to"
      ...
      <nav
        class="md:ml-auto md:mr-auto pl-24 flex flex-wrap items-center text-base justify-center"
      >
        <a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900"
          >Home</a
        >
