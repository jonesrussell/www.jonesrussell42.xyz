<div class="min-w-screen  bg-gray-100">
	...
	<header class="text-gray-700 body-font bg-white shadow-sm w-full border-t border-gray-100">
		<div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
			<nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">Home</a>
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">About</a>
				<a href="https://dev.to" class="font-medium hover:text-gray-900">Contact</a>
			</nav>
			<a
				href="https://dev.to"
			...
			<div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0 h-full items-center">
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">Login</a>
				<a
					href="https://dev.to"
					class="bg-teal-500 text-white active:bg-teal-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none transition-all duration-150 ease"
				>
					Sign Up
				</a>
			</div>
	...
	<!-- Header Menu Center -->
	<header class="text-gray-700 body-font bg-white shadow-sm w-full mt-5 border-t border-gray-100">
		<div class="container mx-auto flex p-6 flex-col md:flex-row items-start justify-between">
			<a
				href="https://dev.to"
			...
			<nav class="md:ml-auto md:mr-auto pl-24 flex flex-wrap items-center text-base justify-center">
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">Home</a>
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">About</a>
				<a href="https://dev.to" class="font-medium hover:text-gray-900">Contact</a>
			</nav>
	...
	<!-- Header Menu Right -->
	<header class="text-gray-700 body-font bg-white shadow-sm w-full mt-5">
		<div class="container mx-auto flex p-6 flex-col md:flex-row items-start">
			<a
				href="https://dev.to"
				class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0"
			>
			...
			<div class="h-full items-center ml-6 pl-6 border-l border-gray-200">
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">Login</a>
				<a
					href="https://dev.to"
					class="bg-teal-500 text-white active:bg-teal-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none transition-all duration-150 ease"
	...
	<header class="text-gray-700 body-font bg-white shadow-sm w-full mt-5 border-t border-gray-100">
		<div class="container mx-auto flex p-6 flex-col md:flex-row items-start justify-between">
			...
			<nav
				class="ml-6 pl-6 border-l border-gray-200 md:mr-auto flex flex-wrap items-center text-base justify-center"
			>
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">Home</a>
				<a href="https://dev.to" class="mr-5 font-medium hover:text-gray-900">About</a>
				<a href="https://dev.to" class="font-medium hover:text-gray-900">Contact</a>
