		...
		<form class="w-full max-w-lg">
				...
				<div class="flex flex-wrap mb-6 -mx-3">
					<div class="w-full px-3 mb-6">
						...
						<input
							...
							id="grid-email"
							type="email"
							placeholder="janedeo@example.com"
						/>
					</div>
					<div class="w-full px-3 mb-6">
						<label
					...
					<div class="flex mt-2 ">
						...
						<div class="p-2">
							<label class="inline-flex items-center">
								<input
									type="radio"
									class="text-pink-600 form-radio"
									name="radio-colors"
									value="3"
								/>
			...
			<div class="flex items-center justify-between p-5 text-center bg-gray-200">
				<div class="relative flex flex-col items-start mr-1 text-sm">
					...
					<a href="https://dev.to" class="block font-medium text-indigo-600 underline">Login Here</a
					>
				</div>
				<button
					type="button"
					class="inline-flex items-center px-6 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:ring-indigo active:bg-indigo-700"
				>
					Register Now
				</button>
			</div>
