			...
			<div class="w-full md:w-1/2 px-10 mt-16 md:mt-0">
				<div class="bg-white shadow-xl rounded-lg overflow-hidden">
					...
					<div class="p-12">
						...
						<div class="mt-10">
							<div>
								<div class="uppercase text-gray-900 font-semibold tracking-wider">Irene Sims</div>
				...
				<div class="mt-10 flex">
					...
					<div class="ml-4 mt-2">
						...
						<p class="mt-2 text-gray-700">
							Filled to the rim with radical features and rock'n sock'n tools. You'll be glad you
							signed up.
						</p>
					</div>
				</div>
