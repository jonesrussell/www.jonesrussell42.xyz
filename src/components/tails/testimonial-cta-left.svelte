	...
	<div class="max-w-6xl mx-auto bg-gray-100 px-10">
		<div class="flex items-center">
			<div class="w-1/2 flex flex-col justify-center items-start h-full pr-8">
				<p class="text-indigo-500 uppercase text-base font-medium tracking-tight mb-2">
			...
			<div class="w-1/2">
				<blockquote
					class="w-full flex items-center justify-between p-6 col-span-1 bg-white rounded-lg shadow"
				>
					<div class="flex flex-col pr-8">
						<div class="pl-12 relative">
							<svg
								class="w-10 h-10 fill-current text-indigo-500 absolute left-0"
						...
						<h3 class="pl-12 text-gray-800 text-base mt-3 leading-5 font-medium truncate">
							Jane Cooper
				...
				<blockquote
					class="w-full flex items-center justify-between p-6 col-span-1 bg-white rounded-lg shadow mt-4"
				>
