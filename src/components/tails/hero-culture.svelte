  ...
  <div class="flex max-w-6xl mx-auto">
    ...
    >
      ...
      <p class="relative z-20 block text-xl mt-4">
        We've created the ultimate resource for turning your culture into a
        super-powered productivity machine by encouraging collaboration growth,
        and incentives!
      </p>
      <div class="flex mt-4">
        <a
    ...
    <div
      class="w-1/2 relative rounded-lg overflow-hidden shadow-2xl cursor-pointer group"
    >
      <div
