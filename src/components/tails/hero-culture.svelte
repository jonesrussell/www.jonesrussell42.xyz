...
>
	...
	<div class="flex max-w-6xl mx-auto">
		<div
			class="w-1/2 container text-white text-2xl font-hairline relative pb-1 px-10 flex flex-col pr-12"
		>
			<h2 class="text-5xl text-white font-extrabold relative z-20 leading-tight">
				Build a culture<br />
				that excels
			</h2>
			<p class="relative z-20 block text-xl mt-4">
				We've created the ultimate resource for turning your culture into a super-powered
				productivity machine by encouraging collaboration growth, and incentives!
			</p>
			<div class="flex mt-4">
				<a
					href="https://dev.to"
