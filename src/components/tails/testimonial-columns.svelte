...
<div class="bg-white px-10">
	<div class="container mx-auto flex justify-center items-center flex-col py-12">
		...
		<img alt="Foo" class="lg:flex justify-center items-center w-full mt-16 mb-4" />
		<img
			alt="Foo"
		...
		<img alt="Foo" class="w-16 h-16 bg-gray-200 rounded-full mr-4 overflow-hidden" />
		<img
			alt="Lorem"
		...
		<blockquote class="text-gray-500 mt-8 text-lg">
			"This is some rad shit! Pop lockin, Boom shockin radical. I immediately wet my pants after
			trying this service."
		</blockquote>
		<div
		...
		>
			...
			<blockquote class="text-gray-500 mt-8 text-lg">
				"Thanks for creating this service. My life is so much easier. Thanks for making such a great
				product."
			</blockquote>
		</div>
		<div class="h-auto w-full lg:w-1/3 flex justify-start items-start flex-col">
			...
			<blockquote class="text-gray-500 mt-8 text-lg">
				"Packed with awesome content and exactly what I was looking for. I would highly recommend
				this to anyone."
			</blockquote>
		</div>
	</div>
