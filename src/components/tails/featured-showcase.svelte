		...
		<div class="w-full lg:flex">
			<div class="w-full lg:w-1/2 xl:w-2/3">
				<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-5">
					<img alt="Foobar" src="https://picsum.photos/300/300?grayscale&random=1" />
					<img alt="Foobar" src="https://picsum.photos/300/300?grayscale&random=2" />
					<img alt="Foobar" src="https://picsum.photos/300/300?grayscale&random=3" />
					<img alt="Foobar" src="https://picsum.photos/300/300?grayscale&random=4" />
					<img alt="Foobar" src="https://picsum.photos/300/300?grayscale&random=5" />
					<img alt="Foobar" src="https://picsum.photos/300/300?grayscale&random=6" />
				</div>
			</div>
			<div class="mt-10 lg:mt-0 w-full lg:flex-1 lg:w-1/2 xl:w-1/3 ml-0 lg:ml-10">
				<div class="bg-black text-white px-20 py-10 lg:h-full">
					...
					<div class="mt-10">
						<a class="flex text-green-500 hover:text-green-800" href="https://dev.to">
							<div class="flex-initial">Learn more about us</div>
							<svg
								class="flex-shrink ml-5 w-4 fill-current"
								version="1.1"
