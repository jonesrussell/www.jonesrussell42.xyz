  ...
  <div class="container px-10 mx-auto sm:px-5">
    <div class="w-full lg:flex">
      <div class="w-full lg:w-1/2 xl:w-2/3">
        <div
          class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-5"
        >
          <img
            alt="Foobar"
      ...
      <div
        class="mt-10 lg:mt-0 w-full lg:flex-1 lg:w-1/2 xl:w-1/3 ml-0 lg:ml-10"
      >
        <div class="bg-black text-white px-20 py-10 lg:h-full">
          ...
          <div class="mt-10">
            <a
              class="flex text-green-500 hover:text-green-800"
              href="https://dev.to"
            >
