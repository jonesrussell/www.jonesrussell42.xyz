...
<div
  class="flex items-center w-full h-screen mx-6 bg-white md:m-0 md:justify-center">
  <ul
    class="flex flex-col items-start space-y-4 md:flex-row md:space-y-0 md:space-x-4">
    <li
      class="flex text-sm leading-none text-gray-900 border border-gray-400 rounded-md">
      <button
      ...
      <a
        class="flex items-center px-3 py-2 font-semibold"
        href="https://dev.to">124</a>
    </li>
    <li
      x-data={openFalse}
          ...
          <div class="flex flex-col">
            <button
              ...
              <div class="flex flex-col space-y-1 text-left">
                ...
                <span class="text-xs leading-normal">Be notified only when
                  participating or @mentioned.</span>
              </div>
            </button>
            <span class="h-0 border-b border-gray-400" />
            <button
      ...
      <a
        class="flex items-center px-3 py-2 text-sm font-semibold leading-none"
        href="https://dev.to">4</a>
    </li>
