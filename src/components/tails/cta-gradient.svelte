<div class="flex items-center justify-center  p-5 bg-gray-100 min-w-screen">
	...
	>
		...
		<p
			class="mt-1 mb-10 text-sm font-medium text-indigo-200 uppercase xl:text-base xl:tracking-wider lg:mb-0"
		>
		...
		<div class="flex mb-8 lg:mt-6 lg:mb-0">
			<div class="inline-flex">
				<a
					href="https://dev.to"
					class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-indigo-700 transition duration-150 ease-in-out bg-indigo-100 border border-transparent rounded-md hover:text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:ring focus:border-indigo-300"
				>
					Sign Up Today
				</a>
			</div>
