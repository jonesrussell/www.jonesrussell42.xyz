<script type="ts">
	export const pretitle = 'Our Latest Courses';
	export const title = 'Watch And Learn with our';
</script>
	...
	>
		...
		>
			<svg
				...
				/></svg
			>
			<span class="relative">{pretitle}</span>
		</h2>
		<a href="https://dev.to" class="text-sm font-semibold text-indigo-600 underline mt-3"
			>View our full library of courses</a
		>
		...
		<div class="grid max-w-lg gap-5 mx-auto mt-12 md:grid-cols-2 lg:grid-cols-3 md:max-w-none">
			<div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
				...
				<div class="flex flex-col justify-between flex-1">
					<div class="flex flex-col justify-between flex-1 p-6 bg-white">
						<div>
							<a href="https://dev.to" class="block text-xl font-semibold leading-7 text-gray-900"
			...
			<div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
				...
				<div class="flex flex-col justify-between flex-1">
					<div class="flex flex-col justify-between flex-1 p-6 bg-white">
						<div>
							<a href="https://dev.to" class="text-xl font-semibold leading-7 text-gray-900"
								>Laravel Dusk</a
							>
							<p class="mt-3 text-base leading-6 text-gray-500">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
