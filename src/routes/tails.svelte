...
<svelte:head>
  <title>'Tails' Components | Russell Jones</title>
</svelte:head>

<header class="flex justify-center">
  <h1 class="text-center text-3xl page-title animated delay slideInDown">
    Tails Components
  </h1>
</header>
...
<div class="">
  ...
  <section>
    ...
    <ContentBrowser>
      ...
      some rock'n poppin features that will leave you wanting more. We've got a jampacked
      feature set of awesomeness that will blow your pants right off!
    </ContentBrowser>
  </section>
  ...
  <section>
    ...
    <ContentCard>
      <span class="font-bold">Our Platform</span> will help you craft and build your
      next idea. Utilize our drag and drop components to build the application of
      your dreams.
    </ContentCard>
  </section>
    ...
    <section class="relative py-6 min-w-screen animation-fade animation-delay">
      ...
      >
        <div class="h-full sm:flex">
            ...
            <div class="flex items-start py-3">
              ...
              <div class="flex-grow ml-10 md:ml-5">
                ...
                <span class="text-gray-500 text-md"
                  >2503 Washington Avenue, Hattiesburg, Mississippi 39402</span
                >
              </div>
            </div>
          ...
          <div
            class="flex items-center justify-center w-full p-10 bg-white md:w-2/3"
          >
            <FormContactSimple />
          </div>
        </div>
